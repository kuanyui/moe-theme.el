...
(defun moe-light ()
  ...
  (cond ((eq moe-theme-mode-line-color 'blue)
        ...
        ((eq moe-theme-mode-line-color 'purple)
         ...
         (set-face-attribute 'mode-line-buffer-id nil :background "#af5fd7" :foreground "#080808")
        ...
        ((eq moe-theme-mode-line-color 'red)
         ...
         (set-face-attribute 'mode-line-buffer-id nil :background "#ff4b4b" :foreground "#080808")
        ...
        ((eq moe-theme-mode-line-color 'w/b)
         ...
         (set-face-attribute 'mode-line-buffer-id nil :background "#8a8a8a" :foreground "#080808")
...
(defun moe-dark ()
  ...
  (cond ((eq moe-theme-mode-line-color 'blue)
        ...
        ((eq moe-theme-mode-line-color 'green)
         ...
         (set-face-attribute 'mode-line-buffer-id nil :background "#d7ff5f" :foreground "#080808")
         (set-face-attribute 'minibuffer-prompt nil :foreground "#005f00" :background "#a1db00"))
        ((eq moe-theme-mode-line-color 'orange)
         (set-face-attribute 'mode-line nil :background "#ff8700" :foreground "#ffffff")
         (set-face-attribute 'mode-line-buffer-id nil :background "#ff8700" :foreground "#080808")
         (set-face-attribute 'minibuffer-prompt nil :foreground "#080808" :background "#ffaf5f"))
        ((eq moe-theme-mode-line-color 'magenta)
         (set-face-attribute 'mode-line nil :background "#ff4ea3" :foreground "#ffffff")
         (set-face-attribute 'mode-line-buffer-id nil :background "#ff4ea3" :foreground "#080808")
        ...
        ((eq moe-theme-mode-line-color 'purple)
         (set-face-attribute 'mode-line nil :background "#af5fff" :foreground "#ffffff")
         (set-face-attribute 'mode-line-buffer-id nil :background "#9a08ff" :foreground "#080808")
        ...
        ((eq moe-theme-mode-line-color 'cyan)
         (set-face-attribute 'mode-line nil :background "#5faf87" :foreground "#ffffff")
         (set-face-attribute 'mode-line-buffer-id nil :background "#5faf87" :foreground "#080808")
