...
(defun moe-light ()
  ...
  (cond ((eq moe-theme-mode-line-color 'blue) ;要考慮到powerline的顏色搭配...orz
        ...
        ((eq moe-theme-mode-line-color 'orange)
         ...
         (set-face-attribute 'mode-line-buffer-id nil :background "#ff8700" :foreground "#1c1c1c")
        ...
        ((eq moe-theme-mode-line-color 'magenta)
         ...
         (set-face-attribute 'mode-line-buffer-id nil :background "#ff4ea3" :foreground "#3a3a3a")
        ...
        ((eq moe-theme-mode-line-color 'purple)
         ...
         (set-face-attribute 'mode-line-buffer-id nil :background "#af5fd7" :foreground "#000000")
         (set-face-attribute 'minibuffer-prompt nil :foreground "#af5fd7" :background "#000000"))
        ((eq moe-theme-mode-line-color 'red)
         (set-face-attribute 'mode-line nil :background "#ff4b4b" :foreground "#ffffff")
         (set-face-attribute 'mode-line-buffer-id nil :background "#ff4b4b" :foreground "#000000")
         (set-face-attribute 'minibuffer-prompt nil :foreground "#ff4b4b" :background "#000000"))
        ((eq moe-theme-mode-line-color 'cyan)
         (set-face-attribute 'mode-line nil :background "#5faf87" :foreground "#ffffff")
         (set-face-attribute 'mode-line-buffer-id nil :background "#5faf87" :foreground "#3a3a3a")
         (set-face-attribute 'minibuffer-prompt nil :foreground "#5faf87" :background "#3a3a3a"))
        ((eq moe-theme-mode-line-color 'w/b)
         (set-face-attribute 'mode-line nil :background "#8a8a8a" :foreground "#ffffff")
         (set-face-attribute 'mode-line-buffer-id nil :background "#8a8a8a" :foreground "#000000")
         (set-face-attribute 'minibuffer-prompt nil :foreground "#8a8a8a" :background "#000000")))
...
(defun moe-dark ()
  ...
  (cond ((eq moe-theme-mode-line-color 'blue) ;要考慮到powerline的顏色搭配...orz
         ...
         (set-face-attribute 'mode-line-buffer-id nil :background "#5fafd7" :foreground "#3a3a3a")
         (set-face-attribute 'minibuffer-prompt nil :foreground "#1f5bff" :background "#ffffff"))
        ((eq moe-theme-mode-line-color 'green)
         (set-face-attribute 'mode-line nil :background "#d7ff5f" :foreground "#005f00")
         (set-face-attribute 'mode-line-buffer-id nil :background "#a1db00" :foreground "#3a3a3a")
         (set-face-attribute 'minibuffer-prompt nil :foreground "#5faf00" :background "#ffffff"))
        ((eq moe-theme-mode-line-color 'orange)
         (set-face-attribute 'mode-line nil :background "#ff8700" :foreground "#3a3a3a")
         (set-face-attribute 'mode-line-buffer-id nil :background "#ff8700" :foreground "#000000")
         (set-face-attribute 'minibuffer-prompt nil :foreground "#ff5d17" :background "#ffffff"))
        ((eq moe-theme-mode-line-color 'magenta)
         (set-face-attribute 'mode-line nil :background "#ff4ea3" :foreground "#ffffff")
         (set-face-attribute 'mode-line-buffer-id nil :background "#ff4ea3" :foreground "#000000")
         (set-face-attribute 'minibuffer-prompt nil :foreground "#ff1f8b" :background "#ffffff"))
        ((eq moe-theme-mode-line-color 'yellow)
         (set-face-attribute 'mode-line nil :background "#fce94f" :foreground "#875f00")
         (set-face-attribute 'mode-line-buffer-id nil :background "#fce94f" :foreground "#3a3a3a")
         (set-face-attribute 'minibuffer-prompt nil :foreground "#875f00" :background "#ffffff"))
        ((eq moe-theme-mode-line-color 'purple)
         (set-face-attribute 'mode-line nil :background "#9a08ff" :foreground "#ffffff")
         (set-face-attribute 'mode-line-buffer-id nil :background "#9a08ff" :foreground "#000000")
         (set-face-attribute 'minibuffer-prompt nil :foreground "#6c0099" :background "#ffffff"))
        ((eq moe-theme-mode-line-color 'red)
         (set-face-attribute 'mode-line nil :background "#ff4b4b" :foreground "#ffffff")
         (set-face-attribute 'mode-line-buffer-id nil :background "#ff4b4b" :foreground "#000000")
         (set-face-attribute 'minibuffer-prompt nil :foreground "#a40000" :background "#ffffff"))
        ((eq moe-theme-mode-line-color 'cyan)
         (set-face-attribute 'mode-line nil :background "#5faf87" :foreground "#ffffff")
         (set-face-attribute 'mode-line-buffer-id nil :background "#5faf87" :foreground "#3a3a3a")
         (set-face-attribute 'minibuffer-prompt nil :foreground "#005f5f" :background "#ffffff"))
        ((eq moe-theme-mode-line-color 'w/b)
         (set-face-attribute 'mode-line nil :background "#ffffff" :foreground "#3a3a3a")
         (set-face-attribute 'mode-line-buffer-id nil :background "#9e9e9e" :foreground "#000000")
      ...
      (progn
        (cond ((eq (frame-parameter nil 'background-mode) 'light)
            ...
            ((eq (frame-parameter nil 'background-mode) 'dark)
             (set-face-attribute 'mode-line-buffer-id nil :background nil :foreground "#000000")
             ...
             (cond ((eq moe-theme-mode-line-color 'blue)
                   ...
                   ((eq moe-theme-mode-line-color 'cyan)
                    ...
                    (set-face-attribute 'powerline-active1 nil :background "#87d7af" :foreground "#005f5f"))
                   ((eq moe-theme-mode-line-color 'w/b)
                    (set-face-attribute 'mode-line nil :background "#ffffff" :foreground "#000000")
                    (set-face-attribute 'powerline-active1 nil :background "#bcbcbc" :foreground "#3a3a3a")
                    (set-face-attribute 'mode-line-buffer-id nil :background nil :foreground "#3a3a3a")))))
        (powerline-default-theme)
        (powerline-reset)
        (setq moe-theme-powerline-enable-p t))
    (message "Powerline not found. Please install first and (require 'powerline)." )))
