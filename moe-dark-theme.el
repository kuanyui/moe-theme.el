...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(mode-line-buffer-id ((,class (:foreground ,black-5 :background ,blue-1 :bold t))))
   ...
   `(ediff-fine-diff-A ((,class (:foreground ,white-0 :background ,magenta-3 :bold t))))
   `(ediff-fine-diff-Ancestor ((,class (:foreground ,white-0 :background ,magenta-3 :bold t))))
   `(ediff-fine-diff-B ((,class (:foreground ,white-0 :background ,magenta-3 :bold t))))
   `(ediff-fine-diff-C ((,class (:foreground ,white-0 :background ,magenta-3 :bold t))))
