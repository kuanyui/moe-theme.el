...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(org-special-keyword ((,class (:background ,black-2-5 :foreground ,black-5))))
   ...
   `(org-agenda-date-weekend ((,class (:foreground ,blue-1 :underline t :bold nil))))
   `(org-agenda-date-today ((,class (:foreground ,blue-0 :slant italic :weight bold))))
   `(org-agenda-column-dateline ((,class (:foreground ,white-0 :background ,black-3 :underline nil))))
