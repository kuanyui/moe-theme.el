...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(gnus-signature ((,class (:italic t :foreground ,black-2))))
   `(gnus-splash ((,class (:foreground ,black-1))))
   `(gnus-summary-cancelled ((,class (:foreground ,black-2))))
   `(gnus-summary-high-ancient ((,class (:bold t :foreground ,red-3))))
   `(gnus-summary-high-read ((,class (:bold t :foreground ,red-1))))
   `(gnus-summary-high-ticked ((,class (:bold t :foreground ,red-2))))
   `(gnus-summary-high-undownloaded ((,class (:foreground ,red-2))))
   `(gnus-summary-high-unread ((,class (:bold t :foreground ,red-0))))
   `(gnus-summary-low-ancient ((,class (:italic t :foreground ,green-3))))
   `(gnus-summary-low-read ((,class (:italic t :foreground ,green-2))))
   `(gnus-summary-low-ticked ((,class (:italic t :foreground ,green-2))))
   `(gnus-summary-low-undownloaded ((,class (:foreground ,green-2))))
   `(gnus-summary-low-unread ((,class (:italic t :foreground ,green-2))))
   `(gnus-summary-normal-ancient ((,class (:foreground ,blue-2))))
   `(gnus-summary-normal-read ((,class (:foreground ,blue-1))))
