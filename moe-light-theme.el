...
(let ((class '((class color) (min-colors 89)))
      ...
      (cyan-1 "#87ffff") (cyan-2 "#87d7af") (cyan-3 "#00d7af") (cyan-4 "#87af87") (cyan-5 "#5faf87")
  ...
  (custom-theme-set-faces
   ...
   `(gnus-signature ((,class (:italic t :foreground ,black-5))))
   ...
   `(gnus-summary-high-ticked ((,class (:bold t :foreground ,red-3))))
   `(gnus-summary-high-undownloaded ((,class (:foreground ,red-1))))
   ...
   `(gnus-summary-low-undownloaded ((,class (:foreground ,red-1))))
   `(gnus-summary-low-unread ((,class (:italic t :foreground ,black-1))))
   `(gnus-summary-normal-ancient ((,class (:foreground ,yellow-3))))
   `(gnus-summary-normal-read ((,class (:foreground ,black-1))))
   `(gnus-summary-normal-ticked ((,class (:foreground ,red-2))))
   `(gnus-summary-normal-undownloaded ((,class (:foreground ,black-1))))
   `(gnus-summary-normal-unread ((,class (:foreground ,black-4))))
