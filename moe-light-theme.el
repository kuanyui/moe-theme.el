...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-string-face ((,class (:foreground ,blue-2))))
   ...
   ;; Rainbow-delimiters
   `(rainbow-delimiters-depth-1-face ((,class (:bold t :foreground ,purple-2))))
   ...
   `(rainbow-delimiters-depth-8-face ((,class (:bold t :foreground ,green-3))))
