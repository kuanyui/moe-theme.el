...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(magit-diff-context-highlight ((,class (:foreground ,black-3 :inherit (magit-section-highlight)))))
   ...
   `(magit-diff-removed-highlight ((,class (:foreground ,red-3 :bold t :inherit (magit-section-highlight)))))
