...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(org-agenda-date-weekend ((,class (:foreground ,yellow-3 :underline t :bold nil))))
   `(org-agenda-date-today ((,class (:foreground ,orange-2 :slant italic :weight bold))))
   `(org-agenda-column-dateline ((,class (:foreground ,white-0 :underline nil))))
