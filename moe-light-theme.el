...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(gnus-summary-high-ticked ((,class (:bold t :foreground ,red-2 :background nil))))
   `(gnus-summary-high-undownloaded ((,class (:foreground ,red-2 :background nil))))
   `(gnus-summary-high-unread ((,class (:bold t :foreground ,white-0 :background ,red-3))))
   ...
   `(gnus-summary-low-unread ((,class (:slant italic :background ,green-4 :foreground ,white-0))))
   ...
   `(gnus-summary-normal-unread ((,class (:background ,blue-3 :foreground ,white-0 :bold t))))
